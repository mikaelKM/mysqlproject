...
include("../includes/bootstrap.php");
  ...
  <!-- body -->
<div class='container'>
<?php include('../admin/dbmanupulation.php'); ?>

  <div class="jumbotron">
  <h1 class="display-6">ADD Department</h1>
...
<div class="jumbotron">
  <h1 class="display-6">ADD EMPLOYEE</h1>
  <form method='POST' action=''>
  <div class="row">
    <div class="col">
...
<div class="jumbotron">
  <h1 class="display-6">ADD EMPLOYEE  WORK DETAILS</h1>
  <form method='POST' action=''>
  <div class="row">
    <div class="col">
      <input type="number" class="form-control" placeholder="Employee ID" name='empl_id' required>
