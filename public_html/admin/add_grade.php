...
<input type="number" name="grade_basic" class="form-control" id="grade_basic">
</div>
</div>
</div>
...
<div class="row">
    ...
    <input type="number" name="grade_HA" class="form-control" id="grade_HA">
</div>
</div>
<div class="col">
<div class="form-group">
<label for="grade_TA">Transport Allowance</label>
<input type="number" name="grade_TA" class="form-control" id="grade_TA">
</div>
</div>
...
<input type="number" name="grade_MA" class="form-control" id="grade_MA">
</div>
</div>
</div>
...
<input type="number" name="grade_bonus" class="form-control" id="grade_bonus">
</div>
</div>
...
<input type="number" name="grade_tas" class="form-control" id="grade_tas">
</div>
</div>
<div class="col">
